...
public class SocialBundleHelper {
    ...
    public static String getItemDescription( final String key ) {
        Collection<IOCBeanDef<SocialBundleService>> socialBundleServices = IOC.getBeanManager().lookupBeans( SocialBundleService.class );
        String value = null;

        for ( IOCBeanDef<SocialBundleService> serviceBean : socialBundleServices ) {
